...
public class MainActivity extends AppCompatActivity implements
  ...
  private void checkBluetooth() {
    ...
    if (mBluetoothAdapter == null) {
      ...
      if (!mBluetoothAdapter.isEnabled()) {
        boolean isMuted = getApplicationContext().getSharedPreferences(Global.PREFS_NAME, MODE_PRIVATE)
                .getBoolean(Global.BLUETOOTH_NOTIFICATION_MUTED, false);
        if (!isMuted) {
          openBluetoothDialog();
        }
      }
  ...
  private void openBluetoothDialog() {
    ...
    builder.setView(inflater.inflate(R.layout.bluetooth_dialog, null))
            ...
            .setNeutralButton(R.string.bluetooth_mute_button, new DialogInterface.OnClickListener() {
              @Override
              public void onClick(DialogInterface dialog, int which) {
                getApplicationContext()
                        .getSharedPreferences(Global.PREFS_NAME, MODE_PRIVATE)
                        .edit()
                        .putBoolean(Global.BLUETOOTH_NOTIFICATION_MUTED, true)
                        .apply();
              }
            });
    builder.create().show();
