...
public class GeofenceFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView overlayImaveView = (ImageView) view.findViewById(R.id.geofenceOverlayImageView);
        ...
        if(!Global.getInstance().getSavedArtists().contains(mContentId)) {
            ...
            overlayImaveView.setVisibility(View.VISIBLE);
            overlayImaveView.setImageResource(android.R.color.transparent);

            Glide.with(mCardView.getContext())
                    .load(R.drawable.discoverable)
                    .dontTransform() //or the alpha will be ignored
                    .into(overlayImaveView);
        } else {
            overlayImaveView.setVisibility(View.GONE);
